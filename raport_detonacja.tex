...
$T_0=\SI{293}{\kelvin}$. Pole ciśnienia rejestrowano w~sondach
...
ciśnienie za~czołem $P_2$ & \SI{2,60}{bar} & Cantera \\
...
Obliczone ciśnienie za~falą ($P_2=\SI{2,60}{bar}$) pokrywa się z~poziomem
...
\item Stan za~falą padającą obliczony w~Canterze ($P_2=\SI{2,60}{bar}$) jest
...
$T_0=\SI{293}{\kelvin}$; ciśnienie $P_0=\SI{1,024}{bar}$ odczytano
